...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/kuba/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["luasnip-latex-snippets.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/kuba/.local/share/nvim/site/pack/packer/opt/luasnip-latex-snippets.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/kuba/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  vimtex = {
    loaded = true,
    path = "/home/kuba/.local/share/nvim/site/pack/packer/start/vimtex",
